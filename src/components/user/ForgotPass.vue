    ...
    <div class="row m-2">
        ...
        <div class="col-md-6 z1 " >
            <div class="heading text-center" style="margin-top: 12rem;">
                <h2 class="h4 fw-bolder ">Forgot password No problem!!</h2>
                <p class="text-muted h5 p1">Please enter email id for verification</p>
            </div>
            ...
            <div class="btns flex-column d-flex mt-3">
                <router-link to="VeriFication" style="text-decoration: none;"><p class="s1 mb-3 text-center">Submit</p></router-link>
            </div>
            <div class="others text-center ">
              <router-link to="SignIn" style="text-decoration: none;"><p class="text-muted">Back to sign in</p></router-link>
            </div>
